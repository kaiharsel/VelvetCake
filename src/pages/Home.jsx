...
export default function Home() {
  return (
    <>
      <Seo
        title=""
        description="VelvetCake — торти, весільні торти, капкейки та бенто у Львові. Також кенді-бари, десерти й майстер-класи ручної роботи. Швидке замовлення за телефоном 093 106 79 43"
        path="/"
      />
      <Hero />
